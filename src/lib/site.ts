export const site = {
  ...
  heroHighlights: [
    ...
    },
    {
      ...
      detail: 'Loaves, pav, buns, and evening bakes designed for daily neighborhood visits.',
    },
    {
  ...
  menuItems: [
    {
      ...
      category: 'Breads',
      price: '₹180',
      tags: ['Best seller', 'Fresh daily'],
    },
    {
      name: 'Chocolate Truffle Cake',
      category: 'Cakes',
      price: '₹1,299',
      tags: ['Eggless option', 'Custom message'],
    },
    {
      name: 'Almond Croissant',
      category: 'Pastries',
      price: '₹140',
      tags: ['Morning batch', 'Crispy finish'],
    },
    {
      name: 'Nankhatai Tin',
      category: 'Cookies',
      price: '₹320',
      tags: ['Giftable', 'House recipe'],
    },
    {
      name: 'Paneer Puff',
      category: 'Savories',
      price: '₹70',
      tags: ['Tea time', 'Spiced filling'],
    },
    {
      name: 'Wedding Cake Consultation',
      category: 'Custom Orders',
      price: 'On request',
      tags: ['Planning call', 'Tasting available'],
    },
  ],
  gallery: [
    {
